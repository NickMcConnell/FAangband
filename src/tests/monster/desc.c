...
static int test_get_mon_name_nonunique_0(void *state) {
	...
	struct player_race *dummy_p_race = NULL;
	char buf[30];
	...
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 1);
	require(check_fluff(buf, "  1 crow", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 5);
	require(check_fluff(buf, "  5 crows", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 7, dummy_race, dummy_p_race, 5);
	...
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 8);
	require(check_fluff(buf, "  8 ibises", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 3, dummy_race, dummy_p_race, 8);
	...
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 2);
	require(check_fluff(buf, "  2 dogs of war", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 10, dummy_race, dummy_p_race, 11);
	require(check_fluff(buf, " 11 dogs ", sizeof(buf)));
	ok;
}


static int test_get_mon_name_nonunique_1(void *state) {
	char name1[] = "crow";
	char name2[] = "ibis";
	char name3[] = "dog of war";
	char plural3[] = "dogs of war";
	struct my_test_data *d = (struct my_test_data*) state;
	struct monster_race *dummy_race = &d->race;
	struct player_race *dummy_p_race = &d->p_race;
	char buf[30];

	dummy_race->name = name1;
	dummy_p_race->name = "Plastic";
	dummy_race->plural = NULL;
	rf_wipe(dummy_race->flags);
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 1);
	require(check_fluff(buf, "  1 Plastic crow", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 5);
	require(check_fluff(buf, "  5 Plastic crows", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 7, dummy_race, dummy_p_race, 5);
	require(check_fluff(buf, "  5 Pl", sizeof(buf)));
	dummy_race->name = name2;
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 1);
	require(check_fluff(buf, "  1 Plastic ibis", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 8);
	require(check_fluff(buf, "  8 Plastic ibises", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 3, dummy_race, dummy_p_race, 8);
	require(check_fluff(buf, "  ", sizeof(buf)));
	dummy_race->name = name3;
	dummy_p_race->name = "Fuzzy";
	dummy_race->plural = plural3;
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 1);
	require(check_fluff(buf, "  1 Fuzzy dog of war", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 2);
	require(check_fluff(buf, "  2 Fuzzy dogs of war", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 16, dummy_race, dummy_p_race, 11);
	require(check_fluff(buf, " 11 Fuzzy dogs ", sizeof(buf)));
	ok;
}
...
static int test_get_mon_name_unique_0(void *state) {
	...
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, sizeof(buf), dummy_race, dummy_p_race, 3);
	require(check_fluff(buf, "[U] Gilgamesh", sizeof(buf)));
	fill_fluff(buf, NULL, sizeof(buf));
	get_mon_name(buf, 8, dummy_race, dummy_p_race, 1);
...
static int test_monster_desc_hidden_def_0(void *state) {
	struct my_desc_exp expected0[] = {
		{ 0, MY_SZ, { "it", "it", "it", "it", "it", "it", "it" } },
		{ 0, 2, { "i", "i", "i", "i", "i", "i", "i" } },
		{ MDESC_OBJE, MY_SZ,
			{ "it", "it", "it", "it", "it", "it", "it" } },
		{ MDESC_OBJE, 3, { "it", "it", "it", "it", "it", "it", "it" } },
		{ MDESC_POSS, MY_SZ,
			{ "its", "its", "its", "its", "its", "its", "its" } },
		{ MDESC_POSS, 3, { "it", "it", "it", "it", "it", "it", "it" } },
		...
		{ MDESC_COMMA, MY_SZ,
			{ "it", "it", "it", "it", "it", "it", "it" } },
		{ MDESC_COMMA, 2, { "i", "i", "i", "i", "i", "i", "i" } },
		{ MDESC_PRO_HID, MY_SZ,
			{ "he", "she", "it", "he", "he", "she", "it" } },
		{ MDESC_PRO_HID, 3,
			{ "he", "sh", "it", "he", "he", "sh", "it" } },
...
struct test tests[] = {
	...
	{ "get_mon_name nonunique_1", test_get_mon_name_nonunique_1 },
