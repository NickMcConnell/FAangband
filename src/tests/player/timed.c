...
static int test_inc_check0(void *state) {
	...
	player->state.el_info[flag_idx].res_level = RES_LEVEL_BASE;
	player->known_state.el_info[flag_idx].res_level = RES_LEVEL_BASE;
	...
	eq(result, true);
	require(player->obj_k->el_info[flag_idx].res_level == 0);
	player->state.el_info[flag_idx].res_level = RES_LEVEL_EFFECT;
	st->weapon->el_info[flag_idx].res_level = RES_LEVEL_EFFECT;
	player->body.slots[weapon_slot].obj = st->weapon;
	result = player_inc_check(player, TMD_POISONED, false);
	eq(result, false);
	require(player->obj_k->el_info[flag_idx].res_level != 0);
	player->state.el_info[flag_idx].res_level = RES_LEVEL_MAX;
	player->obj_k->el_info[flag_idx].res_level = 0;
	result = player_inc_check(player, TMD_POISONED, false);
	eq(result, false);
	require(player->obj_k->el_info[flag_idx].res_level != 0);
	...
	eq(result, true);
	require(player->obj_k->el_info[flag_idx].res_level == 0);
	player->state.el_info[flag_idx].res_level =
	...
	result = player_inc_check(player, TMD_OPP_ACID, false);
	eq(result, false);
	require(player->obj_k->el_info[flag_idx].fail].res_level != 0);
	result = player_inc_check(player, TMD_OPP_ACID, true);
	eq(result, false);
#endif
