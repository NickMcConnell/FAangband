...
uint8_t angband_color_table[MAX_COLORS][4] =
{
	...
	{0x00, 0x00, 0x40, 0x20}, /* 29 COLOUR_D_GREEN */
};
...
color_type color_table[MAX_COLORS] =
{
	...
	{'g', "Green", {5, 1, 5, COLOUR_SLATE, COLOUR_L_GREEN, COLOUR_D_GREEN,
	...
	{'y', "Yellow", {11, 1, 11, COLOUR_L_WHITE, COLOUR_L_YELLOW, COLOUR_MUSTARD,
	...
	{'t', "Teal", {18, 1, 6, COLOUR_SLATE, COLOUR_L_TEAL, COLOUR_D_GREEN,
	...
	{'Z', "Deep Light Blue", {27, 1, 14, COLOUR_L_WHITE, COLOUR_L_BLUE, COLOUR_BLUE,
							  COLOUR_L_BLUE, COLOUR_L_BLUE, COLOUR_L_BLUE}},

	{'a', "Shade", {28, 1, 8, COLOUR_SHADE, COLOUR_L_DARK, COLOUR_SHADE,
						 COLOUR_L_DARK, COLOUR_L_DARK, COLOUR_SHADE}},

	{'e', "Dark Green", {29, 1, 5, COLOUR_SLATE, COLOUR_GREEN, COLOUR_SLATE,
					COLOUR_GREEN, COLOUR_GREEN, COLOUR_D_GREEN}},
