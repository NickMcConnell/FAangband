...
RF(SEASONAL,	RFT_GEN,		"")
RF(AMON_RUDH,	RFT_GEN,		"")
RF(NARGOTHROND,	RFT_GEN,		"")
RF(DUNGORTHEB,	RFT_GEN,		"")
RF(GAURHOTH,	RFT_GEN,		"")
RF(ANGBAND,		RFT_GEN,		"")
RF(DUNGEON,		RFT_GEN,		"")
RF(UNAWARE,		RFT_NOTE,		"")
