  ...
  while (!done)
      ...
      if (o_ptr->tval == TV_AMULET)
	{
	  switch(e_idx)
		...
		while (potential > MIN(2000, (2 * initial_potential / 3)))
		  {
			...
			if (randint1(3) == 1)
			  get_quality(TRUE, ADD_CHR, randint1(4), o_ptr);
		    ...
		    /* Remaining 20% just get charisma */
		      ...
		      {
			get_quality(TRUE, ADD_CHR, randint1(bonus), o_ptr);
		...
		if (randint1(2) == 1) 
		  {
		    get_quality(TRUE, RES_ELEC, randint0(4) + 3, o_ptr);
		    if (randint1(3) == 1) 
		      get_quality(TRUE, RES_ACID, randint0(4) + 3, o_ptr);
		  }
		else 
		  {
		    get_quality(TRUE, RES_ACID, randint0(4) + 3, o_ptr);
		...
		if (potential > 1000)
		  {
		    if (randint1(10) == 1) 
		      get_quality(TRUE, RES_COLD, randint0(4) + 5, o_ptr);
		    if (randint1(10) == 1) 
		      get_quality(TRUE, RES_FIRE, randint0(4) + 5, o_ptr);
		  }
		...
		get_quality(TRUE, MAGIC_MASTERY, randint1(bonus), o_ptr);
		...
		if (randint1(5) == 1)
		  get_quality(TRUE, RES_ELEC, randint0(4) + 3, o_ptr);
		if (randint1(5) == 1)
		  get_quality(TRUE, RES_FIRE, randint0(4) + 3, o_ptr);
		if (randint1(5) == 1)
		  get_quality(TRUE, RES_ACID, randint0(4) + 3, o_ptr);
		...
		if (randint1(8) == 1) get_quality(FALSE, VUL_NETHR, 0, o_ptr);
		else if (randint1(8) == 1) get_quality(FALSE, VUL_DISEN, 0, o_ptr);
		done = TRUE;
		break;
	      }
		...
		if (randint1(500) < potential)
		  get_quality(TRUE, SEARCH, 2 + randint0(bonus), o_ptr);
		...
		if (randint1(8) == 1) get_quality(FALSE, VUL_CONFU, 0, o_ptr);
      ...
      else if (o_ptr->tval == TV_RING)
	{
	  switch(e_idx)
		...
		property = select_property(potential, stats, 3, &max_value, 
					   RANDOM_CHOICE, o_ptr);
		get_quality(TRUE, property, randint1(max_value), o_ptr);
		...
		while ((randint1(initial_potential) > initial_potential 
			- potential) && (tries > 0))
		  {
		    max_value = bonus + 1;
		    property = select_property(potential, stats, 3, &max_value, 
		...
		/* Combat bonuses */
		temp = 1 + bonus;
		get_quality(TRUE, ADD_SKILL, temp + randint1(5), o_ptr);
		get_quality(TRUE, ADD_DEADLINESS, temp + randint1(5), o_ptr);
		...
		if (randint1(2) == 1) get_quality(TRUE, RES_POIS, 0, o_ptr);
		...
		if (randint1(2) == 1) 
		  {
		    get_quality(TRUE, RES_FIRE, randint0(4) + 3, o_ptr);
		    if (randint1(3) == 1) 
		      get_quality(TRUE, RES_COLD, randint0(4) + 3, o_ptr);
		  }
		else 
		  {
		    get_quality(TRUE, RES_COLD, randint0(4) + 3, o_ptr);
		...
		if (potential > 1000)
		  {
		    if (randint1(10) == 1) 
		      get_quality(TRUE, RES_ACID, randint0(4) + 5, o_ptr);
		    if (randint1(10) == 1) 
		      get_quality(TRUE, RES_ELEC, randint0(4) + 5, o_ptr);
		  }
		...
		if (randint1(3) == 1) get_quality(FALSE, SEE_INVIS, 0, o_ptr);
		...
		if (randint1(8) == 1) get_quality(FALSE, VUL_NEXUS, 0, o_ptr);
		if (randint1(8) == 1) get_quality(FALSE, VUL_NETHR, 0, o_ptr);
		if (randint1(8) == 1) get_quality(FALSE, VUL_CHAOS, 0, o_ptr);
		if (randint1(8) == 1) get_quality(FALSE, VUL_DISEN, 0, o_ptr);
		
		/* ...but likely to sustain stats */
		if (randint1(3) == 1) get_quality(FALSE, SUST_STR, 0, o_ptr);
		if (randint1(3) == 1) get_quality(FALSE, SUST_INT, 0, o_ptr);
		if (randint1(3) == 1) get_quality(FALSE, SUST_WIS, 0, o_ptr);
		if (randint1(3) == 1) get_quality(FALSE, SUST_DEX, 0, o_ptr);
		if (randint1(3) == 1) get_quality(FALSE, SUST_CON, 0, o_ptr);
...
static void add_properties(object_type *o_ptr)
{
  ...
  if ((potential > 1500) && (randint1(3) != 1))
	...
	{
	  if ((randint1(2) == 1) && (o_ptr->bonus_other[P_BONUS_SPEED] == 0))
	    {
   ...
   */
  if (((randint1(5) < 3) || (potential >= 2000)) && ((!pval) || (pval < 7)))
    {
      pval = randint1(3);
  ...
  {
    if ((o_ptr->to_a % 5 == 4) && (randint1(2) == 1)) o_ptr->to_a++;
    else if ((o_ptr->to_a % 5 == 1) && (randint1(2) == 1)) o_ptr->to_a--;
    else if ((o_ptr->to_a % 2 == 1) && (randint1(4) != 1)) o_ptr->to_a++;
    
    if ((o_ptr->to_h % 5 == 4) && (randint1(2) == 1)) o_ptr->to_h++;
    else if ((o_ptr->to_h % 5 == 1) && (randint1(2) == 1)) o_ptr->to_h--;
    else if ((o_ptr->to_h % 2 == 1) && (randint1(4) != 1)) o_ptr->to_h++;
    
    if ((o_ptr->to_d % 5 == 4) && (randint1(2) == 1)) o_ptr->to_d++;
    else if ((o_ptr->to_d % 5 == 1) && (randint1(2) == 1)) o_ptr->to_d--;
    else if ((o_ptr->to_d % 2 == 1) && (randint1(4) != 1)) o_ptr->to_d++;
  }
}
  ...
  for (i = 0; i < gauntlet_runs; i++)
    {
      ...
      if ((o_ptr->to_h > 0) && (randint1(2) == 1)) wheel_of_doom = 2;
      else if ((o_ptr->to_a > 0) && (randint1(2) == 1))  wheel_of_doom = 1;
	  ...
	  if (randint1(2) == 1)
	    {
	      ...
	      if (randint1(3) != 1) o_ptr->to_d = -(5 + randint1(7)) * 2;
	    }
      ...
      if (wheel_of_doom == 3)
	{
	  if (randint1(3) != 1)
		...
		{
		  for (j = 0; j < A_MAX; j++)
		    if (randint1(4) == 1) o_ptr->bonus_stat[j] = penalty;
		}
      ...
      if (wheel_of_doom == 4)
	{
	  if (randint1(4) == 1) o_ptr->bonus_other[P_BONUS_SHOTS] = 0;
	  if (randint1(4) == 1) o_ptr->bonus_other[P_BONUS_MIGHT] = 0;
	  if (randint1(3) == 1) o_ptr->multiple_slay[P_SLAY_ANIMAL] = 10;
	  ...
	  if (randint1(3) == 1) o_ptr->multiple_brand[P_BRAND_FIRE] = 10;
	  if (randint1(3) == 1) o_ptr->multiple_brand[P_BRAND_COLD] = 10;
