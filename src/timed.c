...
static timed_effect effects[] =
{
	...
	{ "You feel safe from evil!", "You no longer feel safe from evil.",
			...
			0, 0, MSG_PROT_EVIL },
	{ "You feel your magical vulnerablity diminish.", "Your magical defences fall to their normal values.",
			NULL, NULL,
	...
	{ "You are mantled in shadow from ordinary eyes!", "You are exposed to common sight once more.",
			NULL, NULL,
