...
EFFECT(STAR_BURST,					false,	"dam",		3,		EFINFO_BALL,	"rain %d balls of light with radius %d near the caster, dealing %s damage")
EFFECT(AIR_SMITE,					false,	"dam",		3,		EFINFO_BALL,	"rain 8 balls of gravity, light or electricity with radius 1 near the caster, dealing %s damage")
