...
static const struct command_info game_cmds[] =
{
	...
	{ CMD_CHOOSE_MAP, "select map", do_cmd_choose_map, false, false, 0 },
	...
	{ CMD_RESHAPE, "change shape", do_cmd_reshape, false, true, 0 },
	{ CMD_MOVE, "move house", do_cmd_move_house, false, false, 0 },
